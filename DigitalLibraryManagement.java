...
class DigitalLibraryManagement{
    ...
    {
        map.put(1,"ECE : Embedded Systems");
        map.put(2,"ECE : Digital Signal Processing");
        map.put(3,"EE : Electric Drive");
        map.put(4,"CSBS : Power System-1");
        map.put(5,"CSBS : Power System-2");
        ...
        map.put(32,"ECE : Renewable Energy Sources");
    ...
    public void admin_login()
    {
        ...
        loginto.put("Xxxx",12345);
        loginto.put("Xxxxjj",67894);
    ...
    public void user_login()
    {
        ...
        System.out.print("Enter Password: ");
        int password = sc.nextInt();
        loginto.put("Maya",57666);
        loginto.put("Teju",57799);
        loginto.put("Rohan",12452);
        loginto.put("Malu",24667);
        loginto.put("Teena",44444);
